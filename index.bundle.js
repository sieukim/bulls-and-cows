...
inputs[3].addEventListener('input', (0, _utils.onInput)(submitButton)); // 규칙 설명 보여주기 button 객체 가져오기

const showRuleButton = document.getElementById('showRule-button'); // 규칙 설명 보여주기 button 객체에 onClick 핸들러 등록

showRuleButton.addEventListener('click', _utils.onClickShowRuleButton); // 규칙 설명 닫기 button 객체 가져오기

const closeRuleButton = document.getElementById('closeRule-button');
closeRuleButton.addEventListener('click', _utils.onClickCloseRuleButton);
...
exports.validInputs = exports.onSubmit = exports.onInput = exports.onClickShowRuleButton = exports.onClickCloseRuleButton = exports.initInputs = exports.hasNaNInput = exports.hasEmptyInput = exports.hasDuplicatedInput = exports.getInputs = exports.createDiv = exports.createButton = exports.createAnswer = exports.checkAnswer = void 0;
...
const onClickShowRuleButton = () => {
  // modal 객체 가져오기
  const ruleModal = document.getElementById('rule-modal'); // display 변경

  ruleModal.style.display = 'flex';
}; // 규칙 설명 닫기 button onClick 핸들러


exports.onClickShowRuleButton = onClickShowRuleButton;

const onClickCloseRuleButton = () => {
  // modal 객체 가져오기
  const ruleModal = document.getElementById('rule-modal'); // display 변경
...
exports.onClickCloseRuleButton = onClickCloseRuleButton;
